...
function Profile() {
  ...
  return (
    <div className={`fixed top-[9%] right-0 border-2 border-gray-300 rounded-lg shadow-lg w-1/4 transition-transform ease-in-out duration-300 transform ${clickonprofile ? "translate-x-0": "translate-x-full"} `}>
